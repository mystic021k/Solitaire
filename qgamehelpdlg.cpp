	...
	: QDialog(parent)
{
	...
	ui.textBrowser->setHtml(
		...
		+ pStart + "There are two traditional boards:" + newline
		+ spanStart + newline + "English:" + newline + "<img src=\":/icon/gif/board_english.gif\">" + newline + spanEnd
		+ spanStart + newline + "European:" + newline + "<img src=\":/icon/gif/board_european.gif\">" + newline + spanEnd
		+ pEnd
	);
}
